...
public class MenuScreen implements Screen {
  ...
  public void show() {
    ...
    newGameLabel.setPosition((640 - newGameLabel.getWidth()) / 2, 220);
    ...
    TextureAtlas textureAtlas =
        GameManager.getInstance().getAssetManager().get("img/actors.pack", TextureAtlas.class);
    indicator0 =
        new Image(new TextureRegion(textureAtlas.findRegion("MainMenuLogo"), 0, 0, 40, 26));
    indicator0.setSize(80f, 52f);
    indicator0.setPosition(positionX, positionY);

    indicator1 =
        new Image(new TextureRegion(textureAtlas.findRegion("MainMenuLogo"), 40, 0, 40, 26));
