...
public class GameScreen implements Screen {
    ...
    public GameScreen(BomGame bomGame) {
        ...
        viewport = new FitViewport(GameManager.WIDTH / GameManager.PPM, GameManager.HEIGHT / GameManager.PPM, camera);
        ...
        audiButton = new TextButton("Audio on", skin);
    ...
    public void show() {
        GameManager.getInstance().playMusic("SuperBomberman-Area1.ogg", true);
        stage = new Stage(new FitViewport(GameManager.WIDTH, GameManager.HEIGHT), bomGame.batch);
        pauseWindow = new Window("Pause", skin);
        pauseWindow.setPosition((GameManager.WIDTH - pauseWindow.getWidth()) / 2 + 10,
