...
public class GameScreen implements Screen {
    ...
    public void show() {
        ...
        stage = new Stage(new FitViewport(BomGame.WIDTH, BomGame.HEIGHT), bomGame.batch);
        pauseWindow = new Window("Pause", skin);
        pauseWindow.setPosition((BomGame.WIDTH - pauseWindow.getWidth()) / 2, (BomGame.HEIGHT - pauseWindow.getHeight()) / 2);
        pauseWindow.setVisible(paused);
        pauseWindow.setSize(BomGame.WIDTH / 2, BomGame.HEIGHT / 2);
        ...
        pauseWindow.add(continueButton).padBottom(10f);
        pauseWindow.row();
