...
import com.bom.game.entity.ItemFlameUp;
import com.bom.game.entity.ItemSpeedUp;
...
public class WorldContactListener implements ContactListener {
    ...
    public void beginContact(Contact contact) {
        ...
        if (fixA.getFilterData().categoryBits == BitCollision.FLAME || fixB.getFilterData().categoryBits == BitCollision.FLAME) {
        ...
        if (fixA.getFilterData().categoryBits == BitCollision.BOMBERMAN || fixB.getFilterData().categoryBits == BitCollision.BOMBERMAN) {
            if (fixA.getFilterData().categoryBits == BitCollision.ITEM || fixB.getFilterData().categoryBits == BitCollision.ITEM) {
                ...
                Fixture bombermanFixture = fixA.getFilterData().categoryBits == BitCollision.BOMBERMAN ? fixA : fixB;
