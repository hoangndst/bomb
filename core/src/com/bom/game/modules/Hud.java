...
public class Hud implements Disposable {
	...
	public Hud(SpriteBatch sb) {
		...
		viewport = new FitViewport(GameManager.WIDTH, GameManager.HEIGHT,
		...
		scoreLabel = new Label(String.format("%06d", GameManager.score),
				labelStyle);
		scoreLabel.setFontScale(0.2f);
		timeLabel = new Label("Time", labelStyle);
		timeLabel.setFontScale(0.2f);
		levelLabel = new Label("1-" + GameManager.CurrentLevel, labelStyle);
	...
	public void update(float dt) {
		...
		levelLabel.setText("1-" + GameManager.CurrentLevel);
	}

	public static void addScore(int value) {
		GameManager.score += value;
		scoreLabel.setText(String.format("%06d", GameManager.score));
	}
