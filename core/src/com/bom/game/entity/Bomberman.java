...
public class Bomberman extends EntityBase implements Disposable {
  ...
  public boolean canPlaceBombs = true;
  private BombPool bombPool;
  public float time = 0.8f;
  private Vector2 initPosition;
  public boolean duplicateBombPlace;
  ...
  private void checkExplode(float deltaTime) {
    if (!canPlaceBombs && !duplicateBombPlace) {
  ...
  public void update(float deltaTime) {
    ...
    sprite.setPosition(UnitHelper.box2DToScreen(body.getPosition().x, bodyDiameter),
        UnitHelper.box2DToScreen(body.getPosition().y, bodyDiameter));
